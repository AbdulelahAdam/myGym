      ...
      <div class="bg-white p-6 rounded-lg mt-6" id="memberNames">
        <div class="mb-7">
          ...
          @if($member->membership_status == "Cancelled")
            <p class="font-bold text-sm">Status: <span class="text-red-600 font-bold text-sm">Cancelled!!</span></p>

          @elseif (Carbon\Carbon::parse($member->membership_to)->isPast())
            <p class="font-bold text-sm">Status: <span class="text-red-500 font-bold text-sm">Expired!!</span></p>

          @else

            <p class="font-bold text-sm">Status: <span class="text-green-500 font-bold text-sm">Expires in {{
